...
pub use raftstore2::store::peer_storage::RAFT_INIT_LOG_INDEX;
const MAX_SNAP_TRY_CNT: usize = 5;
const RAFT_LOG_MULTI_GET_CNT: u64 = 8;

pub use raftstore2::store::peer_storage::INIT_EPOCH_VER;
pub use raftstore2::store::peer_storage::INIT_EPOCH_CONF_VER;

// One extra slot for VecDeque internal usage.
const MAX_CACHE_CAPACITY: usize = 1024 - 1;
const SHRINK_CACHE_CAPACITY: usize = 64;

pub use raftstore2::store::peer_storage::JOB_STATUS_PENDING;
pub use raftstore2::store::peer_storage::JOB_STATUS_RUNNING;
pub use raftstore2::store::peer_storage::JOB_STATUS_CANCELLING;
pub use raftstore2::store::peer_storage::JOB_STATUS_CANCELLED;
pub use raftstore2::store::peer_storage::JOB_STATUS_FINISHED;
pub use raftstore2::store::peer_storage::JOB_STATUS_FAILED;
