...
use crate::db_options::SimpleTitanDBOptions;
...
impl CFOptionsExt for SimpleEngine {
...
pub struct SimpleColumnFamilyOptions;

impl ColumnFamilyOptions for SimpleColumnFamilyOptions {
